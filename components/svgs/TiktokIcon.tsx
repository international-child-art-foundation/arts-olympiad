...
export const TiktokIcon = (props: SVGProps<SVGSVGElement>) => (
  <Link href="https://www.tiktok.com/@internationalchildartfdn" target="_blank" rel="noopener noreferrer">
    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" aria-labelledby="tiktok"  {...props}>
      <title id="tiktok"> Visit the International Child Art Foundation's Tiktok page</title>
