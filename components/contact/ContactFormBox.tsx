      ...
      <div className="col-span-1 flex flex-row lg:flex-col">
        <div className="flex flex-col">
          ...
          <div className="flex flex-row mt-12 mb-6">
            <Image
              src="/contact/geo-mark.svg"
              alt=""
              width={30}
              height={0}
              className="max-h-[30px] mr-4 mt-0"
            />
            <div className="flex flex-col">
              <Pm className="">International Child Art Foundation</Pm>
              <Pm className="">Post Office Box 58133</Pm>
              <Pm className="">Washington, DC 20037</Pm>
              <Pm className="">USA</Pm>
            </div>
          </div>
        </div>
        <LazyImage
          imageUrl="icaf-logo.webp"
          alt="ICAF Logo."
