    ...
    <>
      <div className="pt-8 justify-around mx-auto w-full mb-16 md:flex">
        <button type="button"
          ...
          className="group flex text-center bg-neutral-white border-new-blue border rounded text-base font-normal text-new-blue w-full md:w-fit me-auto mr-5 cursor-pointer"
        >
        ...
        <button type="submit"
          className="border rounded text-center text-base font-normal w-full md:w-fit py-4 px-10 ms-auto bg-new-blue ml-5 border-new-blue cursor-pointer text-neutral-white"
        >
