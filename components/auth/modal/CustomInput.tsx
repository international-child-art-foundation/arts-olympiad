  ...
  return(
    <div className={`grid ${props.colSpan || props.colStart ? `${props.colSpan ? props.colSpan : ""} ${props.colStart ? props.colStart : ""}` : ""}`}>
      ...
      <input 
        {...field} 
        {...props} 
        className={`w-full placeholder-[#403F4C] border rounded pl-4 pr-4 pt-2 pb-2 ${meta.error && meta.touched ? "border-[#C4384E]" : !meta.error && meta.touched ? "border-[#158737]": "border-neutral-black"}`}
      />
