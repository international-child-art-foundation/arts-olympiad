...
export const BirthdateForm: React.FC<BirthdateFormProps> = ({
  ...
  const [birthdateSubmissionLoading, setBirthdateSubmissionLoading] =
    useState(false);
    ...
    <>
      ...
      >
        {({ errors, touched, values }) => (
          <Form
            className={`${
              birthdateSubmissionLoading && "blur-sm opacity-80"
          ...
          >
            <RegisterDateOfBirth
              ...
              touched={
                touched.birthdate ?? { day: false, month: false, year: false }
              }
