...
export const ArrowCTA: React.FC<ArrowCTAProps> = ({ text, href }) => {
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center group text-dark-blue font-bold underline p-2 pl-0 rounded z-10 font-normal hover:font-bold">
      <span>{text}</span>
