      ...
      <div className={`${className} my-1 flex items-start`}>
        ...
        <div className={labelClass}>
          {over14 ? (
            <>
              I agree to the{" "}
              <a className={linkClass} target="_blank" rel="noopener noreferrer" href="https://icaf.org/documents/myfavoritesport/MyFavoriteSport_Terms_of_Use.pdf" onClick={(e) => e.stopPropagation()}>
                Terms of Use
              </a>{" "}
              and{" "}
              <a className={linkClass} target="_blank" rel="noopener noreferrer" href="https://icaf.org/documents/myfavoritesport/MyFavoriteSport_Privacy_Policy.pdf" onClick={(e) => e.stopPropagation()}>
                Privacy Policy
              </a>
            </>
          ) : (
