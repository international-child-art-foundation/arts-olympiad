  ...
  return (
    ...
    >
      <article className=" text-center md:flex flex-col py-10">
        <H2m className="font-medium font-montserrat text-3xl hidden lg:block">
          General Benefits
        </H2m>
        <H2m className="font-medium font-montserrat text-3xl lg:hidden">
      ...
      <div className="flex flex-nowrap flex-col lg:space-x-6 lg:flex-row justify-between">
        <VisionCard
          ...
          texture={
            <div className=" w-full absolute bottom-0 left-0 select-none pointer-events-none">
              <Image
                src="/svgs/blobs/mission-blob.svg"
                className="w-[30%]"
                alt=""
                width={0}
                height={0}
        ...
        <VisionCard
          ...
          texture={
            <Image
              src="/svgs/blobs/beginning-blob.svg"
              className="w-[60%] absolute bottom-0 left-0 opacity-40 select-none pointer-events-none"
              alt=""
              width={0}
              height={0}
            />
        ...
        <VisionCard
          ...
          texture={
            <Image
              src="/svgs/blobs/blue-scar-blob.svg"
              className="w-[80%] absolute bottom-0 left-0 select-none pointer-events-none"
              alt=""
              width={0}
              height={0}
            />
        ...
        <VisionCard
          ...
          texture={
            <Image
              src="/sponsor/YellowTexture.png"
              className="w-[50%] absolute bottom-0 left-0 select-none pointer-events-none"
              alt=""
              width={0}
              height={0}
            />
