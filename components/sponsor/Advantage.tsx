...
export const Advantage = () => {
  return (
    <>
      ...
      <Image src={blueBG} alt="" width={685} height={737} className="absolute z-10 hidden sm:block w-full h-max md:w-5/6 mxl:w-3/4 mb-10 -left-28" />

      <section className="z-20 relative m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20">                     
        ...
        <article className="my-10 border-main-orange border-l-8">
          <p className="pt-20 w-2/3 sm:pt-0 mx-5% text-xl md:text-2xl font-semibold text-new-blue">
            People don’t just want to be spectators.
          </p>
          <p className="mt-6 pb-10 ml-36 sm:mt-2 sm:pb-0 sm:mx-5% text-base fond-light md:fond-thin text-new-blue">
