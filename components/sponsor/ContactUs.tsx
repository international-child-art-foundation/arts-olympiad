...
export const ContactUs = () => {
  return (
    <>
      <div className="relative mb-[500px] z-30 bg-light-blue" >
        <Image src={blueBlobMobile} alt="" width={767} height={446} className="absolute z-0 xsm:block w-full h-[1000px]" />
        <div className="absolute left-1/2 transform -translate-x-1/2 translate-y-1/2 grid grid-cols-1 gap-y-6 md:mt-10 lg:mt-20 m-auto max-w-screen-2xl sm:px-8 md:px-12 lg:px-16 xl:px-20">
