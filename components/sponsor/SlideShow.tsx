...
const SlideShow = () => {
  ...
  return (
    <div className="grid grid-cols-1 grid-rows-1 max-w-[1660px] mx-auto">
      <Image src={PinkBlob} alt="" className="col-start-1 row-start-1 z-0 pointer-event-none -mb-12 justify-right"></Image>
