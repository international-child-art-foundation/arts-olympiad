...
export const SponsorBegin = () => {
  return (
    <>
      ...
      <Image src={yellowBGtablet} alt="" width={1279} height={377} className="absolute z-10 hidden lg:block xl:hidden -top-32 w-full h-full" />
      <Image src={yellowBGsmall} alt="" width={1536} height={432} className="absolute z-10 hidden xl:block 2xl:hidden -top-32 w-full h-full" />
      <Image src={yellowBGlarge} alt="" width={1536} height={432} className="absolute z-10 hidden 2xl:block -top-32 w-full h-full" />

      <section className="relative grid grid-cols-2 px-5% mx-auto z-20 mt-10">
        ...
        <div className="col-span-2 mx-auto z-20 sm:col-span-1 sm:ml-10 lg:ml-0">            
          <Image src="/photo-sponsor.png" width = {390} height = {271} className="w-full rounded-[225px] lg:rounded-[300px] shadow-[8px_18px_0_-6px_rgba(251,178,46,1)]" alt="photo" />
        </div>

      </section>

      <article className="px-5% xl:px-10% mx-auto font-extralight text-lg leading-loose pt-36 lg:pt-24">
