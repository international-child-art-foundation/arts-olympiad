    ...
    <>
          ...
          <div className="mx-5%">
            ...
            <div className="flex justify-center">
              <Image
                ...
                width={46}
                height={46}
                className="w-[46px] h-[46px] mr-4 hidden md:block"
              />
            ...
            <ul className="mx-5% list-disc font-light text-lg leading-loose mb-24 md:mb-8">
              <li className="pb-1">
                Promote Olympism in your company and the Olympic values of
                excellence, friendship, and respect.
              </li>
              <li className="pb-1">
                Deepen employee engagement by inviting their children's
                participation in #MyFavoriteSport and providing exciting
                volunteer opportunities in Paris and Washington, D.C.
              </li>
              <li className="pb-6">
                Help fulfill Baron de Coubertin's vision of the Olympics as a
                global showcase of human excellence in art and sports.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="z-20 relative lg:hidden m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20">
        <Image
          ...
          width={100}
          height={100}
          className="z-0 absolute -top-12 left-1/2 transform -translate-x-1/2 w-[100px] h-[100px] md:hidden"
        />
        <div className="bg-baby-blue pt-20 rounded-2xl h-fit md:pt-8">
          <div className="mx-5%">
            <h3 className="text-center font-medium text-3xl pb-10 md:hidden">
              Brighten the Future!
            </h3>
            <div className="flex justify-center">
              <Image
            ...
            <ul className="mx-5% list-disc font-light text-lg leading-loose mb-24 md:mb-8">
              <li className="pb-1">
                Engage creative youth worldwide—a key demographic for long-term
                business growth.
              </li>
              <li className="pb-1">
                Deepen your company's global emotional branding that motivates
                young people to become your brand ambassadors.
              </li>
              <li className="pb-6">
                Grow your audience with social media posts of children's
                masterpieces on sports in the countdown to the World Cup.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="z-20 relative lg:hidden m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20">
        ...
        <div className="bg-light-green pt-20 rounded-2xl h-fit md:pt-8">
          <div className="mx-5%">
            <h3 className="text-center font-medium text-3xl pb-1 md:hidden">
              Make your mark on
            </h3>
            <h3 className="text-center font-medium text-3xl pb-10 md:hidden">
              The National Mall!
            ...
            <ul className="mx-5% list-disc font-light text-lg leading-loose mb-24 md:mb-36">
              <li className="pb-1">
                Join the World Children's Festival—a celebration of creativity,
                diversity, and unity—with your company's "Pavilion," where
                creative activities and empathy training are held.
              </li>
              <li className="pb-1">
                Invite your CEO to deliver a personal "I Have a Dream" address
                from The National Mall.
              </li>
              <li className="pb-6">
                Gain major network exposure at the press conference where the
              ...
              <article className="bg-light-green p-6 rounded-2xl shadow-2xl">
                <div className="mx-5%">
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="absolute left-1/2 transform -translate-x-1/2 w-[100px] h-[100px] -top-12"
                  />
                  <h3 className="text-center font-medium text-3xl pt-10 pb-2">
                    Make your mark on
                  </h3>
                  <h3 className="text-center font-medium text-3xl pb-2">
                    The National Mall!
                  </h3>
                  <ul className="mx-5% list-disc font-light text-lg leading-loose my-4">
                    <li className="pb-1">
                      Join the World Children's Festival—a celebration of
                      creativity, diversity, and unity—with your company's
                      "Pavilion," where creative activities and empathy training
                      are held.
                    </li>
                    <li className="pb-1">
                      Invite your CEO to deliver a personal "I Have a Dream"
                      address from The National Mall.
                    </li>
                    <li className="pb-4">
                      Gain major network exposure at the press conference where
              ...
              <article className="bg-baby-blue p-6 rounded-2xl shadow-2xl">
                <div className="mx-5%">
                  <Image
                    ...
                    className="absolute left-1/2 transform -translate-x-1/2 w-[100px] h-[100px] -top-12"
                  />
                  <h3 className="text-center font-medium text-3xl pt-14">
                    Brighten the Future!
                  </h3>
                  <ul className="mx-5% list-disc font-light text-lg leading-loose my-10">
                    <li className="pb-1">
                      Engage creative youth worldwide—a key demographic for
                      long-term business growth.
                    </li>
                    <li className="pb-1">
                      Deepen your company's global emotional branding that
                      motivates young people to become your brand ambassadors.
                    </li>
                    <li className="pb-16">
                      Grow your audience with social media posts of children's
                      masterpieces on sports in the countdown to the World Cup.
            ...
            >
              ...
              <article className="bg-light-pink p-6 rounded-2xl shadow-2xl">
                <div className="mx-5%">
                  ...
                  <h3 className="text-center font-medium text-3xl py-10">
                    Paris
                  </h3>
                  <ul className="mx-5% list-disc font-light text-lg leading-loose">
                    ...
                    <li className="pb-6">
                      Help fulfill Baron de Coubertin's vision of the Olympics
                      as a global showcase of human excellence in art and
                      sports.
                    </li>
                  </ul>
                </div>
