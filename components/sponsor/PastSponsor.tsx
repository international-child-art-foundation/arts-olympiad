...
export const PastSponsor = () => {
  return (
    <>
      <div className="relative mt-40 grid grid-cols-2 z-30 m-auto  " >
        <div className="xsm:col-span-2 lg:col-span-1 xsm:pl-8 md:pl-12 lg:pl-16 xl:pl-20 max-w-screen-2xl">
...
Please browse this 16-page pdf (3-minutes). </h3> 
          ...
          <div className="">
            <Image src={PastMobile} alt="" width={767} height={446} className="relative z-30 hidden xsm:block w-full right-0 lg:hidden" />
            <Image src={PastXL} alt="" width={1536} height={432} className="relative z-30 hidden 2xl:block right-0 w-full " />
          </div>
        </div> 
      </div>
    </>
