...
Please browse this 16-page pdf (3-minutes). </h3> 
          ...
          <div>
            ...
            <Image src={PastXL} alt="" width={718} height={535} className="absolute z-0 hidden lg:block top-20 md:top-20 lg:top-52 xl:bottom-12 xl:top-56 right-0 w-4/6 lg:w-full lg:-right-28 max-w-[718px]" />
          </div>
        </div> 
      </div>
    </>
