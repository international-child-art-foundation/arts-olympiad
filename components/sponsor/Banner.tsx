  ...
  return (
    <>
      <div className={`relative bottom-0 z-30 bg-${props.backgroundColor} w-screen h-fit`}>
        <div className="grid grid-cols-1 gap-y-6 md:grid-cols-3 md:grid-rows-2 m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20">
          ...
          <Image src={icafLogo} alt="ICAF Logo" className="mx-auto my-auto pt-8 md:pb-8 w-1/2 h-fit order-1 md:order-2 md:w-11/12 md:col-start-3 md:col-end-3 md:row-span-3" />

          <div className="mx-auto mb-8 md:mx-0 h-auto order-3 flex flex-wrap justify-between w-full items-baseline">
