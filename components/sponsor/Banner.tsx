...
export const Banner = () => {
  return (
    <>
      ...
      <div className="relative bottom-0 z-30 bg-baby-blue w-screen h-fit">
        <div className="grid grid-cols-1 gap-y-6 md:grid-cols-3 md:grid-rows-3 m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20">
          ...
          <div className="mx-auto font-thin text-lg order-2 col-span-1 md:col-span-2 md:ml-0">
          ...
          <a href="#" className="mx-auto mb-10 inline-flex w-fit h-fit bg-new-blue rounded text-center py-4 px-6 text-sm cursor-pointer tracking-wide text-neutral-white order-4 md:col-span-2 md:ml-0">Learn more about becoming a sponsor</a>
        </div>
      </div>
    </>
  );
