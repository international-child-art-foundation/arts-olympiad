  ...
  return (
    <>
      ...
      >
        <article
          role="banner"
          className="m-auto md:m-0 z-20 relative flex-col xsm:justify-center xsm:text-center lg:text-left lg:justify-left lg:mt-28 xsm:col-span-2 lg:col-span-1"
        >
          ...
          <p className="md:w-full lg:w-3/4 mt-8 font-regular">
