...
export const Accordion = () => {
  ...
  const [minimalContentWidth, setMinimalContentWidth] = useState<
    number | undefined
  >(0);
  ...
  return (
    ...
    >
      ...
      <article className="md:flex flex-col mr-10 z-5">
        <H2m className="font-medium font-montserrat my-8 text-3xl md:text-4xl">
          ICAF's U.S. and global initiatives
        </H2m>
      </article>
      ...
      >
        <AccordionCard
          ...
          paragraph={
            <>
              <Pm className="lg:my-12 font-openSans font-light">
                For children’s creative development, ICAF organizes the Arts
                Olympiad, a free school art program that has grown over the
                years into the world’s largest. The U.S. Olympic and Paralympic
                Committee has granted ICAF as exclusive license to use the “Arts
                Olympiad” mark.
              </Pm>
              <ArrowCTA
        ...
        <AccordionCard
          ...
          paragraph={
            <>
              <Pm className="my-12 font-openSans font-light">
                For children’s empathic development, ICAF produces the World
                Children’s Festival every four years as the “Olympics” of
        ...
        <AccordionCard
          ...
          paragraph={
            <>
              <Pm className="font-light font-openSans mb-12 lg:my-12">
                ICAF has organized art exhibitions at Olympic venues and its
                Arts Olympiad was integral to New York City’s bid for the 2012
                Olympics.
              </Pm>
          ...
          images={<Image src={OlympicRings} alt="" className="my-10"></Image>}
        />
        <AccordionCard
          minimalContentWidth={minimalContentWidth}
          setMinimalContentWidth={setMinimalContentWidth}
          ...
          paragraph={
            <>
              ...
              <ArrowCTA
                text="When the Olympics gave out medals for art"
          ...
          images={
            <div className="flex flex-col my-10 md:flex-row mx-auto lg:mx-0">
              <LazyImage
                className="min-w-[230px] min-h-[300px] max-w-[230px] max-h-[300px] cursor-default"
                imageUrl="/about/olympic-monument.webp"
                alt="olympic-monument."
              />
              <div className="my-4 md:my-0 mx-4" />
              <LazyImage
                className="min-w-[230px] min-h-[300px] max-w-[230px] max-h-[300px] cursor-default"
                imageUrl="/about/baron-de-couberin.jfif"
                alt="baron-de-couberin."
              />
            </div>
          }
        />
