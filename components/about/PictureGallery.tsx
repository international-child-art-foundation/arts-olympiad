      ...
      <section className="mx-auto max-w-screen-2xl">
        ...
        <div className="grid grid-cols-3 z-20 mt-20 w-full px-20">
          ...
          <div className="z-20 py-5 px-5 relative">
            <Image src={YellowLine} alt="" className="absolute z-10 w-20 -left-10 -top-5"></Image>
            <Image src={snowFlakeLeft} alt="" className="absolute z-10 w-10 -left-10 bottom-0"></Image>
          ...
          <div className="z-20 py-5 px-5 relative">
            <Image src={snowFlakeRight} alt="" className="absolute right-0 mt-20 z-10 w-10 -right-10 bottom-0"></Image>
