...
export const Commitment = () => {
  return (
    ...
    >
      ...
      <div className="min-w-full flex flex-nowrap flex-col lg:flex-row justify-between mt-12">
        ...
        >
          <div className="grid grid-col relative p-6 h-full justify-between">
            <Image
              ...
              alt=""
            ></Image>
            <H2m className="z-20 font-regular font-montserrat text-3xl md:text-4xl">
              Sponsors
            </H2m>
            <Pm className="z-20 font-sans font-light my-4">
              Some of the world’s leading companies have worked with ICAF to win
              over young hearts and minds.
            </Pm>
        ...
        >
          ...
          <div className="grid grid-col relative p-6 h-full">
            <H2m className="font-regular font-montserrat text-3xl md:text-4xl">
              Impact
            </H2m>
      ...
      <Image
        src={footer}
        className="select-none pointer-events-none my-10"
        alt=""
      ></Image>
      {/* <Image
