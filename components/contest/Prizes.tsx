    ...
    <>
      <section className="relative z-30 mt-12 m-auto max-w-screen-2xl ">
        <div className="mt-8 px-8 md:px-12 lg:px-20 xl:px-24 z-30">
          ...
          <Pm className="font-openSans font-light z-30 text-center lg:text-left">People around the world through thir votes will select who wins the Gold (US$3,000), Silver ($2,000) or Bronze ($1,000)</Pm>
        </div>
