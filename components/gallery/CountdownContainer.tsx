  ...
  return (
    <svg width={602 + stroke*2} height={102 + stroke*2} viewBox={`0 0 ${602 + stroke*2} ${102 + stroke*2}`} fill="none" xmlns="http://www.w3.org/2000/svg" transform={`scale(${scale})`}>
      <defs>
        ...
        <mask id="mask">
          <ellipse cx="0" cy="0" rx={30 + stroke} ry="12" fill="#fff" filter="url(#blurFilter)" fillOpacity="10%">
            <animateMotion dur={duration} begin="0s" repeatCount="indefinite" path={ellipsePath} rotate="auto"/>
          </ellipse>
          <ellipse cx="0" cy="0" rx={35 + stroke} ry="10" fill="#fff" filter="url(#blurFilter)" fillOpacity="6%">
            <animateMotion dur={duration} begin="-0.2s" repeatCount="indefinite" path={ellipsePath} rotate="auto"/>
          </ellipse>
          <ellipse cx="0" cy="0" rx={40 + stroke} ry="8" fill="#fff" filter="url(#blurFilter)" fillOpacity="6%">
            <animateMotion dur={duration} begin="-0.1s" repeatCount="indefinite" path={ellipsePath} rotate="auto"/>
          </ellipse>
          <ellipse cx="0" cy="0" rx={45 + stroke} ry="6" fill="#fff" filter="url(#blurFilter)" fillOpacity="6%">
            <animateMotion dur={duration} begin="0.1s" repeatCount="indefinite" path={ellipsePath} rotate="auto"/>
          </ellipse>
          <ellipse cx="0" cy="0" rx={50 + stroke} ry="4" fill="#fff" filter="url(#blurFilter)" fillOpacity="6%">
            <animateMotion dur={duration} begin="0.2s" repeatCount="indefinite" path={ellipsePath} rotate="auto"/>
          </ellipse>
        </mask>
      ...
      <rect x={1 + stroke} y={1 + stroke} width="600" height="100" rx="51" stroke="url(#paint0_linear_3_4)" strokeWidth={stroke}/>
