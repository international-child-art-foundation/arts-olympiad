...
const Button: React.FC<ButtonProps> = ({ children, mainButton,nonNav, link }) => {
  const buttonStyle = mainButton 
    ? nonNav? "bg-main-blue hover:bg-secondary-blue text-white px-4 py-2 rounded-full block": "bg-main-blue hover:bg-secondary-blue text-white px-4 py-2 rounded-full hidden md:block" 
