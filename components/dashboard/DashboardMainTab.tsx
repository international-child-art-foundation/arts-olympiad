...
export const DashboardMainTab: React.FC<DashboardMainTabProps> = ({ dashboardLoadingState }) => {
  ...
  return (
    <div className="p-10">
      ...
      <div>
        <p className="font-montserrat text-2xl font-regular text-[32px]">Welcome {userData?.f_name} to your dashboard</p>
        <p className="font-light text-base py-2 pb-4">See your account information in here!</p>
        <p className="py-2 pt-4 font-montserrat font-semibold text-2xl">Your Artwork</p>
        { userHasActiveSubmission ?
          <div>
            <div className="my-2 p-6 w-full outline outline-1 rounded-3xl h-[400px] w-[81%] max-h-full max-w-full"> 
              {userData && artworkData ? (
                <div className="grid grid-cols-2 h-full">
                  <div className="flex flex-col overflow-hidden gap-4">
                    ...
                    <button className="bg-main-orange rounded-[30px] w-[180px] p-2.5 items-center gap-8 m-auto">
                  ...
                  <div className="flex flex-col pl-4">
                    <div>
                      <p className="text-lg font-semibold">{userData?.f_name} {userData?.l_name}</p>
                      <p className="text-sm">{userData?.age} | {userData?.location}</p>
                      <p className="">Sport categories {artworkData.sport.map((sport) => {
                        return " | " + sport;
                      })}</p>
                ...
                <div className="my-2 w-full rounded-3xl max-h-full max-w-full content-center p-4 text-center"> 
                  ...
                  <p>If this message persists for more than a few seconds, please </p>
          ...
          <div>
            <div className="my-2 w-full outline outline-1 rounded-3xl h-[400px] w-[81%] max-h-full max-w-full content-center"> 
              <button className="flex bg-new-blue rounded text-white p-4 m-auto items-center gap-8">
                {/* onClick => open dashboard modal, beginning submission process */}
                <p>Upload Artwork</p>
