  ...
  date: yup
    ...
    .shape({
      ...
      year: yup
        ...
        .max(2025, "Please enter a valid year")
        .required(),
    })
    ...
    .test(
      "is-old-enough",
      "You need to be 8 or older to enter this competition",
      (value) => {
        const { day, month, year } = value;
...
export const Under14 = () => {
  const { personalFormData, setPersonalFormData, handleNavigation } =
    useStepsContext();
  ...
  return (
    <section className="items-center justify-center m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20 w-full">
      ...
      <div className="mb-4 text-base text-neutral-black font-normal">
        Before we move forward, we need some details from you. Please review and
        agree to our <span className="underline">Terms of Use</span> and{" "}
        <span className="underline">Privacy Policy</span>. By submitting your
        artwork, you're also donating it to ICAF for charitable objectives.
