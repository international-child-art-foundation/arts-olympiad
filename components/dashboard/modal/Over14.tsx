  ...
  return (
    <section className="items-center justify-center m-auto max-w-screen-2xl px-8 md:px-12 lg:px-16 xl:px-20 w-full">
      ...
      <div className="mb-10 text-base text-neutral-black font-normal"> 
        Before we move forward, we need some details from you. Please review and agree to our <a className="underline text-blue-600" target="_blank" href="https://icaf.org/documents/myfavoritesport/MyFavoriteSport_Terms_of_Use.pdf">Terms of Use</a> and <a className="underline text-blue-600" target="_blank" href="https://icaf.org/documents/myfavoritesport/MyFavoriteSport_Privacy_Policy.pdf">Privacy Policy</a>. By submitting your artwork, you're also donating it to ICAF for charitable objectives. Thank you for your support!
      </div>
