  ...
  return(
    <>
      ...
      <div className="flex">
        ...
        {age && 
        (age < 14 ?         
          <span className="text-sm mb-1 ml-2 font-light text-neutral-black"><div className="ml-2 text-base font-light">I, the participant's parent or guardian, agree to ICAF's <a className="font-normal underline" target="_blank" rel="noopener noreferrer" href="https://icaf.org/documents/myfavoritesport/MyFavoriteSport_Terms_of_Use.pdf">Terms of use</a> and <a className="font-normal underline" target="_blank" rel="noopener noreferrer" href="https://icaf.org/documents/myfavoritesport/MyFavoriteSport_Privacy_Policy.pdf">Privacy Policy</a></div></span>
          :         
