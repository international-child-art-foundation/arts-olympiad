      ...
      (
        <>
          ...
          <div>
            ...
            <button onClick={() => setDisplayModal("deleteAccount")}className=" my-10 shadow-md m-auto  rounded-lg text-white px-4 py-3 bg-red-500 hover:bg-red-600 active:scale-[97%]">Delete your account</button>
            }
          </div>
        </>
      ) : (
