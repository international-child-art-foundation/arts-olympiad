...
const icons = [
  {
    SVGcomponent: FacebookIconWhite,
  ...
  {
    SVGcomponent: LinkedinIconWhite,
      ...
      <div className="mx-5% sm:mx-auto sm:max-w-sm md:max-w-full lg:max-w-screen-2xl flex flex-wrap gap-y-10 pt-12 pb-10 px-8 md:px-12 lg:px-16 xl:px-20 justify-between">
        <div className="space-y-3 w-full md:w-2/5 max-w-sm lg:w-30% text-sm text-neutral-white col-span-2 md:order-1 md:col-span-3">
          ...
          <div className="flex flex-wrap gap-1 items-center text-main-grey focus-within:text-gray-600">
            ...
            <a
              href="#"
              className="h-fit sm:flex-1 border-neutral-white whitespace-nowrap border rounded text-center py-2 px-3 text-sm cursor-pointer tracking-wide w-full sm:w-auto text-neutral-white"
            >
              Sign up
            </a>
          </div>
          ...
          <div className="w-1/2 md:w-auto">
            <div className="flex flex-col w-auto items-left md:items-center">
              ...
              <a
                ...
                target="blank"
                rel="noopener noreferrer"
                className="group w-32 lg:w-32 h-fit border-neutral-white border rounded text-center py-3 px-5 text-sm cursor-pointer tracking-wide bg-neutral-white text-new-blue"
              >
                Donate
              </a>
