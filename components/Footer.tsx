...
const Footer = () => {
  return (
    ...
    <footer className="bg-new-blue font-body relative z-10 rounded-t-2xl max-w-[1200px] sm:mx-6 md:mx-5 lg:mx-10 xl:mx-20 2xl:mx-auto overflow-hidden">
      {/* <div className="mx-auto md:max-w-sm lg:max-w-fit grid grid-cols-2 gap-6 lg:grid-cols-6 xl:grid-cols-7 xl:grid-rows-1 pt-8 pb-20 px-2">
        
        <div className="space-y-3 text-sm text-neutral-white col-span-2 lg:order-1 lg:col-span-3">
          <p>Join our newsletter now</p>
          <p>Subscribe to our quartly Sketches</p>
          <div className="flex gap-1 items-center text-main-grey focus-within:text-gray-600">
            <input 
              type="text"
              name="email"
        ...
        <div className="grid gap-5 grid-cols-2 col-span-2 lg:col-start-3 lg:order-4 xl:col-span-1 xl:grid-cols-1"> 
