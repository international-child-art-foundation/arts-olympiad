...
export const GetInvolvedStatic = () => {
  ...
  return (
    <div className="relative">
      <H2m className="col-span-1 z-10 font-medium text-3xl md:text-4xl text-center font-montserrat leading-relaxed px-2" >Join the <span className="italic">#MyFavoriteSport</span> campaign</H2m>
