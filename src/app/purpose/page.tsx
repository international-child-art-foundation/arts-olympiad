        ...
        <div className="bg-neutral-white rounded-2xl p-10 lg:p-5 shadow-md flex flex-col items-start mx-auto w-11/12">
          ...
          <div className="flex flex-col lg:flex-row items-left">
            <div className="flex flex-col items-center lg:w-2/5 lg:mr-10">
              ...
              <div className="flex items-center flex-col my-3 lg:mt-10">
                <Image src="/purpose/illustration-08.svg" alt="A long hair skater with red sweater" width={224} height={224}
                />
              </div>
            </div>
          ...
          <div className="flex flex flex-col lg:flex-row items-left">
            <div className="lg:w-2/5 flex flex-col items-center my-3 lg:mt-14">
              <Image src="/purpose/illustration-06.svg" alt="A smiling water polo player" width={224} height={224} />
            </div>
